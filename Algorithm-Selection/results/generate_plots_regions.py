...
ROOT_DIR = '/home/gorana/Desktop/grips2017/Algorithm-Selection/Performance_Measure/SGM/results/regions'

# path to directory containing configuration files for calculating performance metric
CONFIG_FILES_PATH = '/home/gorana/Desktop/config-files/regions'
...
# run on combination of static and dynamic features regions set
...
print( performance_metric.configuration )
performance_metric.measure_performance_multiple_files( \
    actual_data_type = 'pdi' \
)
# generate plot data for dynamic features using time data
...
# # trained on time
# performance_metric.set_configuration( \
#     config_file_path = os.path.join(CONFIG_FILES_PATH, 'a_scaled_static_time_pdi_config.yml') \
# )
# performance_metric.measure_performance_multiple_files( \
#     actual_data_type = 'pdi' \
# )
# generate plot data for dynamic features using time data
# performance_metric.set_configuration( \
#     config_file_path = os.path.join(CONFIG_FILES_PATH, 'a_scaled_static_time_time_config.yml') \
# )
# performance_metric.measure_performance_multiple_files( \
#     actual_data_type = 'time' \
# )
...
# p.plot_performance(
#     plot_data_dirpath = os.path.join(PLOT_DATA_DIRPATH, 'a_scaled/pdi_pdi'), \
#     plot_dirpath = os.path.join(PLOT_DATA_DIRPATH, 'a_scaled'), \
...
# )
#
# # trained on time, calculated on pdi
# p.plot_performance(
#     plot_data_dirpath = os.path.join(PLOT_DATA_DIRPATH, 'a_scaled/time_pdi'), \
#     plot_dirpath = os.path.join(PLOT_DATA_DIRPATH, 'a_scaled'), \
#     plot_name = 'a_scaled_static_time_pdi' \
# )
# p.plot_performance(
#     plot_data_dirpath = os.path.join(PLOT_DATA_DIRPATH, 'a_scaled/time_pdi'), \
#     plot_dirpath = os.path.join(PLOT_DATA_DIRPATH, 'a_scaled'), \
...
# )
#
# # trained on time, calculated on time
# p.plot_performance(
#     plot_data_dirpath = os.path.join(PLOT_DATA_DIRPATH, 'a_scaled/time_time'), \
#     plot_dirpath = os.path.join(PLOT_DATA_DIRPATH, 'a_scaled'), \
#     plot_name = 'a_scaled_static_time_time' \
# )
# p.plot_performance(
#     plot_data_dirpath = os.path.join(PLOT_DATA_DIRPATH, 'a_scaled/time_time'), \
#     plot_dirpath = os.path.join(PLOT_DATA_DIRPATH, 'a_scaled'), \
...
# p.plot_performance(
#     plot_data_dirpath = os.path.join(PLOT_DATA_DIRPATH, 'b_all_features/pdi_pdi'), \
#     plot_dirpath = os.path.join(PLOT_DATA_DIRPATH, 'b_all_features'), \
